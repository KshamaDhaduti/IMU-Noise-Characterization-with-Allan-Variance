close all
clear all
bag1=rosbag("imuK.bag");
bag2=rosbag("magK.bag");
...
subplot(2,2,1)
plot(or_x)
title("Quartenion Data X")
ylabel("Quartenion X values")
xlabel("Time(sec)")

subplot(2,2,2)
plot(or_y)
title("Quartenion Data Y")
ylabel("Quartenion Y values")
xlabel("Time(sec)")

subplot(2,2,3)
plot(or_z)
title("Quartenion Data Z")
...
subplot(3,1,1)
plot(linacc_x,'b+')
title(" Linear acceleration in X-axis")
ylabel("Linear acceleration(m/s^2)")    
xlabel("Time(seconds)")

subplot(3,1,2)
plot(linacc_y,'b+')
title(" Linear acceleration in Y-axis")
ylabel("Linear acceleration(m/s^2)")
xlabel("Time(seconds)")

subplot(3,1,3)
plot(linacc_z,'b+')
title(" Linear acceleration in Z-axis")
ylabel("Linear acceleration(m/s^2)")
xlabel("Time(seconds)")
...
subplot(3,1,1)
plot(angv_x,'b+')
title(" Angular Velocity in X-axis")
ylabel("Angular Velocity(rad/s)")
xlabel("Time(seconds)")

subplot(3,1,2)
plot(angv_y,'b+')
title(" Angular Velocity in Y-axis")
ylabel("Angular Velocity(rad/s)")
xlabel("Time(seconds)")

subplot(3,1,3)
plot(angv_z,'b+')
title(" Angular Velocity in Z-axis")
ylabel("Angular Velocity(rad/s)")
xlabel("Time(seconds)")
...
subplot(3,1,1)
plot(mag_x,'b+')
title(" Magnetometer measurment in X-axis")
ylabel("Magnetometer measurment (Gauss)")
xlabel("Time(seconds)")

subplot(3,1,2)
plot(mag_y,'b+')
title(" Magnetometer measurment in Y-axis")
ylabel("Magnetometer measurment (Gauss)")
xlabel("Time(seconds)")

subplot(3,1,3)
plot(mag_z,'b+')
title(" Magnetometer measurment in Z-axis")
ylabel("Magnetometer measurment (Gauss)")
xlabel("Time(seconds)")
...
subplot(3,3,1)
plot(err_accelx,'b+')
title(" Linear acceleration absolute error about mean data on X-axis ")
ylabel("Absolute value of error(m/s^2)")
xlabel("Time(seconds)")

subplot(3,3,2)
plot(err_accely,'b+')
title(" Linear acceleration absolute error about mean data on Y-axis")
ylabel("Absolute value of error(m/s^2)")
xlabel("Time(seconds)")

subplot(3,3,3)
plot(err_accelz,'b+')
title(" Linear acceleration absolute error about mean data on Z-axis")
ylabel("Absolute value of error(m/s^2)")
xlabel("Time(seconds)")

subplot(3,3,4)
plot(err_angvx,'b+')
title(" Angular velocity absolute error about mean data on X-axis")
ylabel("Absolute value of error(rad/s)")
xlabel("Time(seconds)")

subplot(3,3,5)
plot(err_angvy,'b+')
title(" Angular velocity in absolute error about mean data on Y-axis")
ylabel("Absolute value of error(rad/s)")
xlabel("Time(seconds)")

subplot(3,3,6)
plot(err_angvz,'b+')
title(" Angular velocity absolute error about mean data on Z-axis")
ylabel("Absolute value of error(rad/s)")
xlabel("Time(seconds)")

subplot(3,3,7)
plot(err_magx,'b+')
title(" Magnetometer readings absolute error about mean data on X-axis ")
ylabel("Absolute value of error(Gauss)")
xlabel("Time(seconds)")

subplot(3,3,8)
plot(err_magy,'b+')
title(" Magnetometer readings absolute error about mean data in Y-axis ")
ylabel("Absolute value of error(Gauss)")
xlabel("Time(seconds)")

subplot(3,3,9)
plot(err_magz,'b+')
title(" Magnetometer readings absolute error about mean data in Z-axis ")
ylabel("Absolute value of error(Gauss)")
xlabel("Time(seconds)")
...
%%
% Stationary 5 hour data analysis

bag3=rosbag("IMU_5.bag");
bsel3=select(bag1,"Topic","imu_data");
...
% Angle random walk coefficient from the line.
logN = slope*log(1) + b;
N = 10^logN
...
% Rate random walk coefficient from the line.
...
% Bias instability coefficient from the line.
